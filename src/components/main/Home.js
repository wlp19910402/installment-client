    ...
    return (
      <div className="qm-fill-width qm-main-home">
        <WingBlank size="md">
          ...
          <Card
            onClick={() => {
              this.props.parent.props.history.push("/bankStaff/selectPerformName");
            }}
          >
            ...
            <div>
              <List>
                <Item
                  ...
                  multipleLine
                  onClick={() => {
                    this.props.parent.props.history.push("/bankStaff/release");
                  }}
                >
            ...
            <div key={item}>
              <List>
                <Item
                  ...
                  multipleLine
                  onClick={() => {
                    this.props.parent.props.history.push(`/msg/${item}`);
                  }}
                >
