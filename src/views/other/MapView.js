                  ...
                  Modal.operation([
                    {
                      text: "高德地图",
                      onPress: () =>
                        tiggerMapApp(MAP_APP_STATUS.MINI_MAP, this.state.targetPosition, this.state.currentPosition),
                    },
                    {
                      text: "百度地图",
                      onPress: () =>
                        tiggerMapApp(MAP_APP_STATUS.BAIDU_MAP, this.state.targetPosition, this.state.currentPosition),
                    },
                    {
                      text: "腾讯地图",
                      onPress: () =>
                        tiggerMapApp(MAP_APP_STATUS.QQ_MAP, this.state.targetPosition, this.state.currentPosition),
                    },
                  ])
                }
              >
